...
const MOCK_USERS = [
  ...
  { id: 'CIT-001', name: 'Ravi Kumar', role: 'citizen', email: 'ravi.k@gmail.com', phone: '9876543200', aadhaar: '895421674301', joined: '10 Jan 2024', status: 'Active', dept: '-', jurisdiction: '-', password: 'password123' },
  { id: 'CIT-002', name: 'Meena Devi', role: 'citizen', email: 'meena.d@gmail.com', phone: '9876543201', aadhaar: '895421674302', joined: '12 Jan 2024', status: 'Active', dept: '-', jurisdiction: '-', password: 'password123' },
  { id: 'CIT-003', name: 'Gopal Rao', role: 'citizen', email: 'gopal.r@gmail.com', phone: '9876543202', aadhaar: '895421674303', joined: '15 Jan 2024', status: 'Suspended', dept: '-', jurisdiction: '-', password: 'password123' },
  { id: 'CIT-004', name: 'Sunita Verma', role: 'citizen', email: 'sunita.v@gmail.com', phone: '9876543203', aadhaar: '895421674304', joined: '18 Jan 2024', status: 'Active', dept: '-', jurisdiction: '-', password: 'password123' },
  { id: 'CIT-005', name: 'Arun Prasad', role: 'citizen', email: 'arun.p@gmail.com', phone: '9876543204', aadhaar: '895421674305', joined: '20 Jan 2024', status: 'Active', dept: '-', jurisdiction: '-', password: 'password123' },
  { id: 'EMP-001', name: 'Suresh Reddy', role: 'officer', title: 'VRO', email: 's.reddy@gov.in', phone: '9876543210', aadhaar: '895421675001', joined: '15 Mar 2023', status: 'Active', dept: 'Revenue Department', jurisdiction: 'Secunderabad', password: 'password123', services: ['Income Certificate', 'Caste Certificate'], cases: 28, sla: 91 },
  { id: 'EMP-002', name: 'Anita Sharma', role: 'officer', title: 'RI', email: 'a.sharma@gov.in', phone: '9876543211', aadhaar: '895421675002', joined: '20 Jan 2023', status: 'Active', dept: 'Revenue Department', jurisdiction: 'Hyderabad Central', password: 'password123', services: ['Income Certificate', 'Residence Certificate'], cases: 34, sla: 87 },
  { id: 'EMP-003', name: 'Ramesh Kumar', role: 'supervisor', title: 'MRO', email: 'r.kumar@gov.in', phone: '9876543212', aadhaar: '895421675003', joined: '10 Jun 2022', status: 'Active', dept: 'Revenue Department', jurisdiction: 'LB Nagar', password: 'password123', services: ['Income Certificate', 'Caste Certificate', 'Record Correction'], cases: 18, sla: 95 },
  { id: 'EMP-004', name: 'Priya Nair', role: 'officer', title: 'Welfare Officer', email: 'p.nair@gov.in', phone: '9876543213', aadhaar: '895421675004', joined: '01 Aug 2022', status: 'Active', dept: 'Welfare Department', jurisdiction: 'All Mandals', password: 'password123', services: ['Welfare Scheme', 'Scholarship Application'], cases: 22, sla: 93 },
  { id: 'EMP-005', name: 'Kiran Babu', role: 'officer', title: 'VRO', email: 'k.babu@gov.in', phone: '9876543214', aadhaar: '895421675005', joined: '05 Nov 2023', status: 'Active', dept: 'Revenue Department', jurisdiction: 'Uppal', password: 'password123', services: ['Income Certificate', 'Caste Certificate'], cases: 31, sla: 88 },
  { id: 'SUP-001', name: 'Deepak Verma', role: 'supervisor', title: 'Supervisor', email: 'd.verma@gov.in', phone: '9876543220', aadhaar: '895421676001', joined: '01 Jan 2022', status: 'Active', dept: 'Revenue Department', jurisdiction: 'Hyderabad District', password: 'password123', services: [], cases: 0, sla: 100 },
  { id: 'SUP-002', name: 'Kavitha Reddy', role: 'supervisor', title: 'Supervisor', email: 'k.reddy@gov.in', phone: '9876543221', aadhaar: '895421676002', joined: '15 Feb 2022', status: 'Active', dept: 'Welfare Department', jurisdiction: 'Telangana State', password: 'password123', services: [], cases: 0, sla: 100 },
  { id: 'GRV-001', name: 'Nalini Rao', role: 'grievance', title: 'Grievance Officer', email: 'n.rao@gov.in', phone: '9876543230', aadhaar: '895421677001', joined: '10 Mar 2022', status: 'Active', dept: 'Grievance Cell', jurisdiction: 'Hyderabad', password: 'password123', services: [], cases: 0, sla: 100 },
  { id: 'GRV-002', name: 'Srinivas Goud', role: 'grievance', title: 'Grievance Officer', email: 's.goud@gov.in', phone: '9876543231', aadhaar: '895421677002', joined: '20 Apr 2022', status: 'Pending', dept: 'Grievance Cell', jurisdiction: 'Warangal', password: 'password123', services: [], cases: 0, sla: 100 },
  { id: 'ADM-001', name: 'Super User', role: 'super_user', title: 'Super User', email: 'superuser@gov.in', phone: '9876543299', aadhaar: '895421678001', joined: '01 Jan 2020', status: 'Active', dept: 'IT Admin', jurisdiction: 'All', password: 'password123', services: [], cases: 0, sla: 100 }
];
...
export function initializeMockData() {
  if (!localStorage.getItem('DigiConnect_initialized_v20')) {
    localStorage.clear();
    ...
    localStorage.setItem('DigiConnect_initialized_v20', 'true');
  }
}
