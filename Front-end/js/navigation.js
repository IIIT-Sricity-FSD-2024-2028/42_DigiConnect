...
import { getSession, getCurrentRole, getCurrentUserName } from './state.js';
import { getRoleConfig, svgIcons } from './role-manager.js';
import { getInitials, toggleSidebar, setupGlobalClickHandlers, initEventDelegation } from './utils.js';
